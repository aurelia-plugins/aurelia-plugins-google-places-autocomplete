System.register(['aurelia-binding', 'aurelia-dependency-injection', 'aurelia-event-aggregator', 'aurelia-templating', './aurelia-plugins-google-places-autocomplete-config'], function (_export, _context) {
  ...
  var bindingMode, inject, EventAggregator, bindable, customElement, Config;
  return {
    ...
    execute: function () {
      ...
      let GooglePlacesAutocomplete = (_dec = customElement('aup-google-places-autocomplete'), _dec2 = inject(Element, Config, EventAggregator), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = _dec2(_class = (_class2 = class GooglePlacesAutocomplete {
            ...
            return regeneratorRuntime.wrap(function _callee$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 2:
                  ...
                  _this._initialized = true;return _context2.abrupt('return');
                ...
                case 5:
                  ...
                  return _context2.abrupt('return', _this._clear());
                ...
                case 7:
                  ...
                  return _context2.abrupt('return', _this._clear(true));
